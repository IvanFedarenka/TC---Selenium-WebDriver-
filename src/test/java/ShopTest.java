...
public class ShopTest {
    ...
    @Test(description = "Cart class test#1: checking does Cart.addRealItem() method increases the 'total Price' value")
    ...
    @Test(description = "Cart class test#2: testing whether the cart name is set correctly")
    public void testGetCartName() {
        assertEquals(cartName, testCart.getCartName(), "'testGetCartName', cart names aren't matches");
    }

    @Test(description = "RealItem class test: testing whether the item's weight is set correctly ")
    ...
    @Test(description = "VirtualItem class test: testing whether the item's size is set correctly ")
